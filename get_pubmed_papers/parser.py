...
def extract_emails(text: str) -> List[str]:
    ...
    # Filter out academic domains
    return [
        email for email in all_emails
        if not re.search(r"\.edu(\.|$)|\.ac\.[a-z]+", email)
    ]
